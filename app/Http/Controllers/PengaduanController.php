...
class PengaduanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Simpan dulu untuk mendapatkan nomor_tiket (jika generate nomor_tiket ada di boot model)
        $pengaduan->save();

        // Handle Upload Bukti (Multiple)
        ...
        // REDIRECT dengan membawa data yang dibutuhkan JavaScript Pop-up
        return redirect()->route('pengaduan.landing')->with([
            'success'      => 'Pengaduan berhasil diajukan!',
            'tiket'        => $pengaduan->nomor_tiket,
            'seksi_tujuan' => $pengaduan->seksi_tujuan, // PENTING: Untuk mapping categoryMap di JS
        ]);
    }
